    ...
    <DashboardLayout>
      ...
      {deleteConfirmId && (
        <div className="fixed inset-0 bg-black/0 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl border-2 border-[#e5e5e5] shadow-xl p-8 max-w-sm mx-4">
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-6 py-3 border-2 border-[#e5e5e5] rounded-xl text-gray-700 font-semibold hover:bg-[#f5f3f0] transition disabled:opacity-50">
                Cancel
              </button>
              <button
                onClick={() => handleDelete(deleteConfirmId)}
                disabled={deleteLoading === deleteConfirmId}
                className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-xl transition disabled:opacity-50 flex items-center gap-2">
